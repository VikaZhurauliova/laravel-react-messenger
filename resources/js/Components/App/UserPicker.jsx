            ...
            <Combobox value={selected} onChange={onSelected} multiple>
                <div className="relative mt-1">
                    ...
                    focus-visible:ring-offset-teal-300 sm:text-sm">
                        <Combobox.Input
                            className="border-gray-300 dark:border-gray-700 dark:bg-gray-500
                    ...
                    <Transition
                        ...
                        afterLeave={() => setQuery("")}
                    >
                        <Combobox.Options className="absolute mt-1 max-h w-full overflow-hidden rounded-md bg-gray-900
