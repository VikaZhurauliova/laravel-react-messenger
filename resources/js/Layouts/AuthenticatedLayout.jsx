    ...
    return (
        <>
            <div className="min-h-screen bg-gray-100 dark:bg-gray-900 flex flex-col h-screen">
                <nav className="bg-white border-b border-gray-100 dark:bg-gray-800">
                                ...
                                <div className="ms-3 flex  relative">
                                    ...
                                    <Dropdown>
                                        ...
                                        <span className="inline-flex rounded-md">
                                            <button
                                                type="button"
                                                className="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white dark:bg-gray-800 dark:text-gray-100 hover:text-gray-700 focus:outline-none transition ease-in-out duration-150"
                                            >
                                                {user.name}
